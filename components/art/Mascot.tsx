...
export function Mascot({ className = "" }: { className?: string }) {
  return (
    ...
    >
      ...
      {/* ソックス —— 蛍光イエロー */}
      <path d="M152 520h46l-3 34h-46z" fill="var(--color-flare)" />
      <path d="M244 520h46l4 34h-46z" fill="var(--color-flare)" />
      ...
      <g transform="rotate(-16 322 246)">
        ...
        <rect x="301" y="204" width="42" height="78" rx="5" fill="var(--color-flare)" />
        <rect x="308" y="216" width="28" height="6" rx="3" fill="var(--color-ink)" />
        <rect x="308" y="230" width="20" height="6" rx="3" fill="var(--color-ink)" />
        <rect x="308" y="252" width="28" height="18" rx="6" fill="var(--color-shock)" />
      </g>
      ...
      {/* サングラス —— 頭上に上げた蛍光フレーム */}
      <g>
        <rect x="166" y="58" width="34" height="24" rx="11" fill="var(--color-flare)" />
        <rect x="224" y="58" width="34" height="24" rx="11" fill="var(--color-flare)" />
        <path d="M200 68h24v6h-24z" fill="var(--color-flare)" />
        <path d="M160 66h8v6h-8z" fill="var(--color-flare)" />
        <path d="M256 66h8v6h-8z" fill="var(--color-flare)" />
      </g>
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <ellipse cx="176" cy="126" rx="9" ry="6" fill="var(--color-shock)" opacity="0.5" />
      <ellipse cx="250" cy="126" rx="9" ry="6" fill="var(--color-shock)" opacity="0.5" />

      {/* イヤリング —— 小さな差し色 */}
      <circle cx="160" cy="122" r="9" stroke="var(--color-ultra)" strokeWidth="5" />
    </svg>
  );
}
